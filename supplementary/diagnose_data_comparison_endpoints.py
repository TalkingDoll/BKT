...
def main():
    ...
    result = dict(
        ...
        definitions=dict(
            ...
            caveat="Tail and boundary observations are associations in these numerical outputs and do not isolate finite-lag regression, dictionary approximation, Euler-Maruyama error or boundary treatment as a cause."),
